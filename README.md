...
The downloadable case data cover Central District in Hong Kong and are available in the [GeoWind3D dataset on Figshare](https://figshare.com/s/a7be4e23c895eaa6182f). Download `central.zip` from the item and extract it. The extracted `central` directory must contain `tileset.json` and its associated tile files.
